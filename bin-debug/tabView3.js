...
var tabView3 = (function (_super) {
    __extends(tabView3, _super);
    function tabView3() {
    ...
    tabView3.prototype.onAddToStage = function () {
        this.name = 'tabView3';
        ...
        this._data.ani3.layers.forEach(function (el, i, arr) {
            this.layers[i] = {};
    ...
    tabView3.prototype.onTimer = function () {
...
__reflect(tabView3.prototype, "tabView3");

...
var tabView4 = (function (_super) {
    __extends(tabView4, _super);
    function tabView4() {
    ...
    tabView4.prototype.onAddToStage = function () {
        this.name = 'tabView4';
        ...
        this._data.ani4.layers.forEach(function (el, i, arr) {
            this.layers[i] = {};
    ...
    tabView4.prototype.onTimer = function () {
...
__reflect(tabView4.prototype, "tabView4");

...
var chanel1 = (function (_super) {
    __extends(chanel1, _super);
    function chanel1() {
    ...
    chanel1.prototype.onAddToStage = function () {
        this.name = 'chanel1';
        ...
        this._data.main.layers.forEach(function (el, i, arr) {
            this.layers[i] = {};
        ...
        this.main_btn = new main_btn();
        this.$parent.addChild(this.main_btn);
    };
    chanel1.prototype.onTimer = function (e) {
            ...
            if (el.frameStopArr.length != 0) {
                if (el.img) {
                    ...
                    el.imgArr.forEach(function (el, i, arr) {
                        ...
                        var texture = arr.length > 2 ? this.texture.layers[i][0].libName : null;
...
__reflect(chanel1.prototype, "chanel1");

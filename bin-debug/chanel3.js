...
var chanel3 = (function (_super) {
    __extends(chanel3, _super);
    function chanel3() {
    ...
    chanel3.prototype.onAddToStage = function () {
        this.name = 'chanel3';
    ...
    chanel3.prototype.onTouchTap = function (e) {
        var target = e.target;
    ...
    chanel3.prototype.onLoaded = function (e) {
        this.music = e.target;
    };
    chanel3.prototype.onTimer = function (e) {
        if (e.target === this.timer)
            this.alpha = 0 + e.target.currentCount * 0.1;
        else {
            switch (e.target.currentCount % 2) {
                case 0:
    ...
    chanel3.prototype.onTimerCpl = function () {
        this.shareImg.alpha = 0;
        this.timerShare.reset();
    };
    chanel3.prototype.onEnterFrame = function () {
...
__reflect(chanel3.prototype, "chanel3");
